...
const colors = {
  ...
  neutral55: "#626F83",
  neutral60: "#525E6F",
  neutral60_10: "rgba(82, 94, 111, 0.1)",
  neutral60_15: "rgba(82, 94, 111, 0.15)",
  neutral60_20: "rgba(82, 94, 111, 0.2)",
  neutral60_30: "rgba(82, 94, 111, 0.3)",
  neutral70: "#3B4554",
  neutral80: "#27313F",
  neutral90: "#1A212B",
  neutral90_10: "rgba(26, 33, 43, 0.1)",
  neutral90_30: "rgba(26, 33, 43, 0.3)",
...
createGlobalTheme(":root", bentoVars, {
  ...
  foregroundColor: {
    ...
    foregroundDisabled: colors.neutral90_30,
  },
  textColor: {
    ...
    textDisabled: colors.neutral60_30,
  },
  interactiveBackgroundColor: {
    ...
    primaryTransparentHoverBackground: colors.neutral90_10,
    primaryTransparentFocusBackground: colors.neutral90_10,
    ...
    secondaryTransparentHoverBackground: colors.neutral90_10,
    secondaryTransparentFocusBackground: colors.neutral90_10,
    ...
    disabledSolidBackground: colors.neutral60_10,
  ...
  interactiveForegroundColor: {
    ...
    disabledSolidForeground: colors.neutral60_30,
    disabledTransparentForeground: colors.neutral60_30,
    linkEnabled: colors.black,
    linkHover: colors.interactive70,
    linkFocus: colors.interactive70,
    linkDisabled: colors.neutral60_30,
    linkEnabledInverse: colors.interactive20,
    linkHoverInverse: colors.white,
    linkFocusInverse: colors.white,
    linkDisabledInverse: colors.neutral60,
  },
  outlineColor: {
    outlineInteractive: colors.black,
    outlineInteractivePrimaryEnabled: colors.black,
    outlineInteractivePrimaryFocus: colors.interactive70,
    outlineInteractivePrimaryHover: colors.interactive70,
    outlineInteractiveSecondaryEnabled: colors.neutral60,
    outlineInteractiveSecondaryFocus: colors.neutral80,
    outlineInteractiveSecondaryHover: colors.neutral80,
    ...
    outlineInteractiveDisabled: colors.neutral60_30,
    ...
    outlineInputDisabled: colors.neutral60_30,
  ...
  boxShadow: {
    ...
    outlineInteractivePrimaryEnabled: `inset 0px 0px 0px 1px ${colors.black}`,
    outlineInteractivePrimaryFocus: `inset 0px 0px 0px 1px ${colors.interactive70}`,
    outlineInteractivePrimaryHover: `inset 0px 0px 0px 1px ${colors.interactive70}`,
    outlineInteractiveSecondaryEnabled: `inset 0px 0px 0px 1px ${colors.neutral60}`,
    outlineInteractiveSecondaryFocus: `inset 0px 0px 0px 1px ${colors.neutral80}`,
    outlineInteractiveSecondaryHover: `inset 0px 0px 0px 1px ${colors.neutral80}`,
    ...
    outlineInteractiveDisabled: `inset 0px 0px 0px 1px ${colors.neutral60_30}`,
    ...
    outlineInputDisabled: `inset 0px 0px 0px 1px ${colors.neutral60_30}`,
