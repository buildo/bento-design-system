...
import { createInternalCheckbox } from "./createInternalCheckbox";
...
export function createCheckbox(config: SelectionControlConfig) {
  const InternalCheckbox = createInternalCheckbox(config);

  return function Checkbox({ value, disabled, ...props }: Props) {
