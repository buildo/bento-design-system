import { Parameters, StoryId, StoryContextForLoaders, AnyFramework, ProjectAnnotations, StoryContextForEnhancers } from '@storybook/csf';
import { StoryIndexStore } from './StoryIndexStore';
import { ArgsStore } from './ArgsStore';
import { GlobalsStore } from './GlobalsStore';
import { processCSFFile } from './processCSFFile';
import { prepareStory } from './prepareStory';
import { CSFFile, ModuleImportFn, Story, NormalizedProjectAnnotations, Path, ExtractOptions, BoundStory, StoryIndex, StoryIndexEntry, V2CompatIndexEntry } from './types';
...
export declare class StoryStore<TFramework extends AnyFramework> {
    ...
    getStoryContext(story: Story<TFramework>): Pick<StoryContextForLoaders<TFramework>, Exclude<keyof StoryContextForLoaders<TFramework>, 'viewMode'>>;
