...
var StoryStore = /*#__PURE__*/function () {
  function StoryStore() {
    ...
    this.processCSFFileWithCache = (0, _memoizerific.default)(CSF_CACHE_SIZE)(_processCSFFile.processCSFFile);
    this.prepareStoryWithCache = (0, _memoizerific.default)(STORY_CACHE_SIZE)(_prepareStory.prepareStory); // We cannot call `loadStory()` until we've been initialized properly. But we can wait for it.
  ...
  _createClass(StoryStore, [{
    ...
    value: function cacheAllCSFFiles() {
      ...
      return this.loadAllCSFFiles().then(function (csfFiles) {
