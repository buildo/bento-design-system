...
var _svelte = _interopRequireDefault(require("./decorators/svelte.svelte"));
...
function wrapper(getStory, context, _ref) {
  ...
  var _getStory = getStory(context),
      Component = _getStory.Component,
      props = _getStory.props,
      on = _getStory.on;
