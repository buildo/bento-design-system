(function (global, factory) {
  ...
  function arrayFrom$1(arrayLike, mapFn) {
    ...
    var A = isCallable$h(C) ? Object(new C(len)) : new Array(len); // 16. Let k be 0.
  ...
  var fails$h = function fails(exec) {
    try {
      return !!exec();
    } catch (error) {
      return true;
  ...
  var getBuiltIn$7 = function getBuiltIn(namespace, method) {
    return arguments.length < 2 ? aFunction(path$b[namespace]) || aFunction(global$d[namespace]) : path$b[namespace] && path$b[namespace][method] || global$d[namespace] && global$d[namespace][method];
  };
  ...
  var aCallable$1 = aCallable$3; // optional / simple context binding
  ...
  */
  ...
  var _export = function _export(options, source) {
    ...
    for (key in source) {
      ...
      else if (PROTO && isCallable$9(sourceProperty)) resultProperty = bind$4(Function.call, sourceProperty); // default case
      ...
      if (PROTO) {
        ...
        createNonEnumerableProperty$5(path$a[VIRTUAL_PROTOTYPE], key, sourceProperty); // export real prototype methods
  ...
  var nativeWeakMap = isCallable$7(WeakMap$2) && /native code/.test(inspectSource$1(WeakMap$2));
  ...
  var EXISTS = has$6(FunctionPrototype, 'name'); // additional protection from minified / mangled / dropped function names
  ...
  var objectGetPrototypeOf = CORRECT_PROTOTYPE_GETTER ? Object.getPrototypeOf : function (O) {
    ...
    if (has$4(object, IE_PROTO)) return object[IE_PROTO];
  ...
  var redefine$4 = function redefine(target, key, value, options) {
  ...
  if (!isCallable$5(IteratorPrototype$1[ITERATOR$4])) {
    redefine$3(IteratorPrototype$1, ITERATOR$4, function () {
      return this;
    });
  }
  ...
  var getIteratorMethod$7 = function getIteratorMethod(it) {
    if (it != undefined) return getMethod$1(it, ITERATOR$1) || getMethod$1(it, '@@iterator') || Iterators$1[classof$7(it)];
  };
  ...
  var getIterator$6 = function getIterator(argument, usingIterator) {
    var iteratorMethod = arguments.length < 2 ? getIteratorMethod$6(argument) : usingIterator;
    if (aCallable(iteratorMethod)) return anObject$4(iteratorMethod.call(argument));
  ...
  var arraySpeciesConstructor$1 = function arraySpeciesConstructor(originalArray) {
    ...
    if (isArray$9(originalArray)) {
      ...
      if (isConstructor$2(C) && (C === Array || isArray$9(C.prototype))) C = undefined;else if (isObject$4(C)) {
        C = C[SPECIES$3];
  ...
  var collection$2 = function collection(CONSTRUCTOR_NAME, wrapper, common) {
    ...
    if (!DESCRIPTORS$4 || !isCallable$1(NativeConstructor) || !(IS_WEAK || NativePrototype.forEach && !fails$7(function () {
